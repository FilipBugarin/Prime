        ...
        bCalculate.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                try {
                    ...
                    Runnable onDone = () -> bCalculate.setEnabled(true); 			// TU MU KAZEMO KAJ DA NAPRAVI KAD ZAVRSI I SALJEMO U SWINGWORKER
                    Consumer<List<Integer>> processChunks = chunks -> {
                    	 for (int primeNumber : chunks) {
                             textArea.append(primeNumber + "\n");					//TU MU KAZEMO KAJ DA SA MEDUREZULTATIMA RADI
                         }
                    };
                    
                    SwingWorker<List<Integer>, Integer> worker = new PrimeNumbersWorker(number, processChunks, onDone);
